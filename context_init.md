...
- [x] PROMPT-3 products — DONE (2026-07-11). ProductCard, products grid, search, filters, sidebar nav. Build passes.
...
- [x] PROMPT-13 settings — DONE (2026-07-11). Shopify connection form, test/save, gateway restart. Build passes.
- [ ] Products
- [ ] Marketing
- [ ] Agents
- [ ] Polish + deploy
